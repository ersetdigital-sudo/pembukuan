...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        // Uber Design System Typography
        "display-xxl": ["64px", { lineHeight: "1.0", letterSpacing: "-0.02em", fontWeight: "700" }],
        "display-xl": ["52px", { lineHeight: "1.22", letterSpacing: "-0.02em", fontWeight: "700" }],
        "display-lg": ["36px", { lineHeight: "1.22", letterSpacing: "-0.02em", fontWeight: "700" }],
        "display-md": ["32px", { lineHeight: "1.22", letterSpacing: "-0.02em", fontWeight: "700" }],
        "heading-lg": ["36px", { lineHeight: "1.22", letterSpacing: "-0.02em", fontWeight: "700" }],
        "heading-md": ["24px", { lineHeight: "1.22", letterSpacing: "0", fontWeight: "700" }],
        "heading-sm": ["20px", { lineHeight: "1.22", letterSpacing: "0", fontWeight: "700" }],
        "body-lg": ["18px", { lineHeight: "1.5", letterSpacing: "0", fontWeight: "400" }],
        "body-md": ["16px", { lineHeight: "1.5", letterSpacing: "0", fontWeight: "400" }],
        "body-sm": ["14px", { lineHeight: "1.5", letterSpacing: "0", fontWeight: "400" }],
        "button-md": ["16px", { lineHeight: "1.0", letterSpacing: "0", fontWeight: "500" }],
        "button-sm": ["14px", { lineHeight: "1.0", letterSpacing: "0", fontWeight: "500" }],
        caption: ["14px", { lineHeight: "1.5", letterSpacing: "0", fontWeight: "500" }],
        "code-md": ["14px", { lineHeight: "1.5", letterSpacing: "0", fontWeight: "400" }],
        "code-sm": ["12px", { lineHeight: "1.67", letterSpacing: "0", fontWeight: "400" }],
      },
      spacing: {
        "sanity-xxs": "2px",
        "sanity-xs": "4px",
